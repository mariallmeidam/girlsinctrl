...
class CardsNoticiasWoman extends StatefulWidget {
  const CardsNoticiasWoman({super.key});

  @override
  State<CardsNoticiasWoman> createState() => _CardsNoticiasWomanState();
}
...
class _CardsNoticiasWomanState extends State<CardsNoticiasWoman> {
